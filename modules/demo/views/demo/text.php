...
<?php echo Text::censor('I used CakePHP and Zend but I likeYiis', Kohana::$config->load('censor.words')); ?>

<br/>

<?php echo Text::censor('I used CakePHP and Zend but I likeYiis', Kohana::$config->load('censor.words'), 'Kohana'); ?>

<br/>

<?php echo Text::censor('I used CakePHP and Zend but I likeYiis', Kohana::$config->load('censor.words'), '*', FALSE); ?>
